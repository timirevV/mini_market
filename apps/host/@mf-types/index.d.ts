...
import type { PackageType as PackageType_1,RemoteKeys as RemoteKeys_1 } from './catalog/apis.d.ts';
import type { PackageType as PackageType_2,RemoteKeys as RemoteKeys_2 } from './provider/apis.d.ts';
